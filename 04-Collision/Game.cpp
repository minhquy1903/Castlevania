...
#define GAME_FILE_SECTION_RESOURCE 3
...
void CGame::_ParseSection_RESOURCE(string line)
{
...
void CGame::Load(LPCWSTR gameFile)
{
	...
	while (f.getline(str, MAX_GAME_LINE))
	{
		...
		if (line == "[RESOURCE]") { section = GAME_FILE_SECTION_RESOURCE; continue; }
		//
		// data section
		//
		switch (section)
		...
		case GAME_FILE_SECTION_SCENES: 
			...
			break;
		case GAME_FILE_SECTION_RESOURCE:
			_ParseSection_RESOURCE(line);
		}
	}
	f.close();
